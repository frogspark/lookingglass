            ...
            <div aria-labelledby="nav-info-tab" class="active fade show pt-6 tab-pane" id="nav-info" role="tabpanel">
              <div class="row">
                <div class="col-12 col-lg-10 col-xl-8">
                  ...
                  <p class="align-items-start align-items-lg-center d-flex flex-column flex-lg-row justify-content-center justify-content-lg-start fs-6"><span class="fw-semibold me-lg-6">USD$575,000</span> <span class="fw-semibold">Listing #7564</span></p>
                  <div class="wysiwyg">
