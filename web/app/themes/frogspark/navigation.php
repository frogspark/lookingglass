...
<?php if (is_front_page()): ?>
  <?php $alt = true; ?>
<?php elseif ($template === 'page-virgin_islands.php' || $template === 'page-about.php' || $template === 'page-news.php' || $template === 'page-advertise.php' || $template === 'page-agent_yacht_search.php'): ?>
  <?php $alt = true; ?>
<?php endif; ?>
